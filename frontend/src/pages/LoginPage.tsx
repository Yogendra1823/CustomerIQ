    ...
    <div className="flex min-h-screen bg-slate-950">
      <div className="hidden flex-1 flex-col justify-between bg-gradient-to-br from-slate-900 via-slate-950 to-cyan-950/40 p-12 lg:flex">
        ...
        >
          <h2 className="text-4xl font-bold leading-tight text-white">
            Intelligent customer segmentation & analytics
          </h2>
          <p className="mt-4 max-w-md text-slate-400">
            Unify RFM scoring, churn prediction, and ML-driven segments in one professional dashboard.
          </p>
        </motion.div>
      ...
      <div className="flex flex-1 items-center justify-center p-8">
        ...
        >
          ...
          <p className="mt-1 text-sm text-slate-400">Access your analytics workspace</p>
          <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="mt-8 space-y-5" noValidate>
            ...
            <Button 
              ...
              variant="secondary" 
              className="w-full" 
              onClick={() => window.location.href = `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000'}/api/v1/auth/google/login`}
            >
